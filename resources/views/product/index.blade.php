                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Title</th><th>Content</th><th>Sell Price</th><th>Purchase Price</th><th>Photo</th><th>Category Id</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($product as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->title }}</td><td>{{ $item->content }}</td><td>{{ $item->sell_price }}</td><td>{{ $item->purchase_price }}</td><td><img src="{{ url('storage')}}/{{ $item->photo }}" width="100" /></td><td>{{ $item->category_id }}</td>
                                        <td>
